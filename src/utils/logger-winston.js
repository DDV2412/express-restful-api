...
const options = {
  alllog: {
    filename: `${appRoot}/src/logs/applog.log`,
    level: "debug",
  ...
  errorlog: {
    filename: `${appRoot}/src/logs/app-error.log`,
    level: "error",
    format: winston.format.combine(
      winston.format.timestamp({ format: appendIsoDate }),
      winston.format.colorize(),
  ...
  warnlog: {
    filename: `${appRoot}/src/logs/app-warn.log`,
    level: "warn",
    format: winston.format.combine(
      winston.format.timestamp({ format: appendIsoDate }),
      winston.format.colorize(),
  ...
  rejection: {
    filename: `${appRoot}/src/logs/app-rejection.log`,
  },
};
